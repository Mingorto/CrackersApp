...
import test.mingorto.crackersapp.common.BaseAdapter;
import test.mingorto.crackersapp.consts.ApiConstants;
import test.mingorto.crackersapp.event.SendCommentEventOnSubscribe;
import test.mingorto.crackersapp.event.SendCreatedPostEventOnSubscribe;
import test.mingorto.crackersapp.event.UploadFileEventOnSubscribe;
import test.mingorto.crackersapp.event.UploadPhotoEventOnSubscribe;
import test.mingorto.crackersapp.model.view.CreatePostTextViewModel;
...
import test.mingorto.crackersapp.ui.dialog.AddAttachmentDialogFragment;
